...
# Cost note: NAT gateways have hourly and data processing charges. Production
# usually uses one per AZ; this skeleton uses one optional gateway for clarity.
